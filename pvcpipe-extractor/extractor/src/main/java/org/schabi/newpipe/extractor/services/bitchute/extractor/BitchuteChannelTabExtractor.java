...
import com.github.pvcpipe.json2java4nanojson.bitchute.api.results.stream.channel.ResultsStreamChannel;
import com.github.pvcpipe.json2java4nanojson.bitchute.api.results.stream.channel.videos.ResultsStreamChannelVideos;
import com.github.pvcpipe.json2java4nanojson.bitchute.api.results.stream.channel.videos.Videos;
...
import org.schabi.newpipe.extractor.utils.PvcPipeExtractorUtils;
...
public class BitchuteChannelTabExtractor extends ChannelTabExtractor {
    ...
    public BitchuteChannelTabExtractor(final StreamingService service,
        ...
        if (linkHandler instanceof PvcPipeExtractorUtils.CustomTabListLinkHandler) {
            this.channelData = ((PvcPipeExtractorUtils
