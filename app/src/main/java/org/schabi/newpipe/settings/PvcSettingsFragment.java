...
import org.schabi.newpipe.pvc.feature.logcat.PvcLogcatUiSetup;
...
public class PvcSettingsFragment extends BasePreferenceFragment {
    @Override
    ...
    private void setupLogcatViewer() {
        ...
        final Preference pref = findPreference(requireContext().getString(
                R.string.pvc_settings_debug_logcat_viewer_key));
        if (null != pref) {
            pref.setOnPreferenceClickListener(preference -> {
                        PvcLogcatUiSetup.INSTANCE.setLogcatOutputFileFormat();
